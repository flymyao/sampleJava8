...
import com.britesnow.j8.test.yao.bean.Programmer;
import com.britesnow.j8.test.yao.bean.Programmers;
...
public class RepeatAnnotationTest {
	...
	public void testMethodAnnotation () {
		Method[] methods = RepeatAnnotationTest.class.getDeclaredMethods();
	...
	public void testRepeatAnnotation () throws Exception, Exception {
		Method method = RepeatAnnotationTest.class.getMethod("testRepeatAnnotation");
		boolean hasAnnotation = method.isAnnotationPresent(Programmers.class); 
		if(hasAnnotation){
			Programmers programmers = method.getAnnotation(Programmers.class);
			Programmer programmerone = programmers.value()[0];
